...
<tbody>
	...
	<td class="adst-table-header-cell">
		<code>[adv_stats_theme_ratings_average theme='theme_slug' outof='5' display='number']</code>
	</td>
	</tr>
	<tr>
	<td class="adst-table-header-cell">
...
<tbody>
	...
	<td class="adst-table-header-cell">
		<code>[adv_stats_ratings_average plugin='plugin_slug' outof='5' display='number']</code>
	</td>
	</tr>
	<tr>
	<td class="adst-table-header-cell">
